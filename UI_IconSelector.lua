...
local savedMaxSliderSize = mrp:IsMainlineClient() and 71892 or 9432;
local tooltipTable = {};
...
local function search_update()
    ...
    local searchBoxContents = MRPIconSelectSearchBox:GetText():upper()
...
local create = function()
    ...
    -- Search box
    f.search_box = CreateFrame( "EditBox", "MRPIconSelectSearchBox", f )
