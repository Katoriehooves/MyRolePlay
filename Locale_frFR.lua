...
L["editor_reportbug_button"] = "Signaler un problème aux développeurs."
L["editor_reportbug_button_tt"] = "Fournit un hyperlien vers la page web des problèmes de MRP, où vous pouvez présenter un problème que vous avez trouvé directement aux développeurs."
L["editor_changelog_button"] = "Voir la liste des changements récents"
L["editor_changelog_button_tt"] = "Voir les changements les plus récents faits sur MyRolePlay, ainsi qu'une explication de nouveaux systèmes mis en place."
...
L["editor_import_button"] = "Importer"
L["editor_import_tt_title"] = "Importer des profils RP à partir d'un autre addon."
L["editor_import_tt_1_active"] = "Vous avez un addon RP autre que MRP chargé et vous pouvez en importer le profil de ce personnage."
L["editor_import_tt_2_active"] = "En dehors de l'importation des profils, vous ne pouvez utiliser qu'un addon RP à la fois. Priez désactiver ces addons après avoir terminé l'importation."
L["editor_import_tt_1_inactive"] = "Vous pouvez charger un autre addon RP compatible, comme par exemple TRP3 ou XRP, en même temps que MyRolePlay afin d'en importer des profils RP."
...
-- MRP Button
L["button_unlocked"] = "Le bouton MRP est déverrouillé, et peut être déplacé à volonté. Cliquez à droite pour le garder en place."
L["button_locked"] = "Le bouton MRP est verrouillé et ne peut pas être déplacé."
L["button_click_to_show"] = "|cffaabbccClic-gauche :|r afficher le profil RP."
L["button_rightclick_to_lock"] = "|cffaabbccClic-droit :|r verrouiller le bouton en place."
L["button_rightclick_to_unlock"] = "|cffaabbccClic-droit :|r déverrouiller le bouton afin de le déplacer."
...
--
L["opt_showfullversiontext"] = "Afficher le titre complet de la version"
L["opt_showfullversiontext_tt"] = [[Afficher la version de l'addon dans sa totalité, ainsi que son nom.]]
--
...
--
L["opt_chatsettings_header"] = "Options de messagerie"
--
...
Notez bien que cette option peut occasionnellement vous prévenir de cibler un joueur en utilisant le clic-droit sur leur nom dans le canal de discussion. Si cela se produit, tentez de désactiver et de réactiver l'option, ou faites un /rl.]]
--
L["opt_rpchatnameguild"] = "|cff40fb40/guilde + /officier|r"
L["opt_rpchatnameguild_tt"]= [[Afficher les noms RP dans les canaux /guilde et /officier, quand connus et disponibles.]]
--
L["opt_highlightemotes"] = "Surligner les |cffff8040émotes|r dans les messages"
L["opt_highlightemotes_tt"]= [[Surligner les émotes contenus à l'intérieur d'|cffff8040*astérisques*|r dans les messages que vous lisez.]]
--
L["opt_highlightooc"] = "Surligner les commentaires |cffaaaaaaHRP|r"
L["opt_highlightooc_tt"]= [[Surligner les commentaires faits hors-RP, tel |cffaaaaaa((HRP))|r dans les messages que vous lisez.]]
--
L["opt_showiconsinchat"] = "Afficher les icônes dans les messages"
L["opt_showiconsinchat_tt"] = [[Afficher les icônes sélectionnées par les joueurs à côté de leurs noms dans les messages que vous lisez.]]
--
