...
-- TODO: Fix these global leaks/weird state variables.
local mrpColourInsert;
local personalityTraitsEditor;
...
function mrp:CreateTraitEditorBars(traitIndex) -- Create personality trait editor bars.
    ...
    frame.ColourLeft:SetScript("OnClick", function (self)
        if not personalityTraitsEditor[traitIndex]["id"] then
            ...
            mrp:ShowColorPicker(r, g, b, 1, function(previousValues)
...
function mrp:UpdateTraitEditorBars(traitIndex, trait)
    ...
    frame.RightIconButton:SetShown(isCustom)
      ...
      if not isCustom then
        ...
        frame.LeftIcon:SetTexture("Interface\\Icons\\" .. mrp.DEFAULT_TRAITS_MAPPING[traitID]["LI"])
        frame.RightIcon:SetTexture("Interface\\Icons\\" .. mrp.DEFAULT_TRAITS_MAPPING[traitID]["RI"])
        frame.LeftText:SetText(mrp.DEFAULT_TRAITS_MAPPING[traitID]["LT"])
        frame.RightText:SetText(mrp.DEFAULT_TRAITS_MAPPING[traitID]["RT"])
        frame.Bar:SetStatusBarColor(0.2, 0.67, 0.86)
        frame.RightFill:SetVertexColor(1, 0.46, 0.8)
    else
...
local function mrp_AddTraitDropdown(frame, level, menuList) -- 1 - 11 (Or more if added to mrp.DEFAULT_TRAITS_MAPPING table) = Default TRP traits. Custom added below as integer 0.
    local info = UIDropDownMenu_CreateInfo()
    for i = 1, #mrp.DEFAULT_TRAITS_MAPPING, 1 do
        info.text, info.func, info.arg1, info.notCheckable = mrp.DEFAULT_TRAITS_MAPPING[i]["LT"] .. " <=> " .. mrp.DEFAULT_TRAITS_MAPPING[i]["RT"], mrp_AddTrait, i, true
...
local function mrp_AddParagraphDropdown(frame, level, menuList)
    local info = UIDropDownMenu_CreateInfo()
    info.text, info.func, info.arg1, info.notCheckable = "Left Alignment", mrp_AddParagraph, "Left", true -- Add left alignment paragraph option
    UIDropDownMenu_AddButton(info)

    info.text, info.func, info.arg1, info.notCheckable = "Centre Alignment", mrp_AddParagraph, "Centre", true -- Add centre alignment paragraph option
    UIDropDownMenu_AddButton(info)

    info.text, info.func, info.arg1, info.notCheckable = "Right Alignment", mrp_AddParagraph, "Right", true -- Add right alignment paragraph option
    UIDropDownMenu_AddButton(info)
end
-----------------------------------------

local function mrp_IconCallbackGlance1Icon(selectedTexture)
    local profile = mrpSaved.SelectedProfile
    if(selectedTexture) then
        local mef = MyRolePlayGlanceEditFrame;
        mef.Glance1IconTexture:SetTexture("Interface\\Icons\\" .. selectedTexture)
        mrpSaved.Profiles[profile]["glances"][1]["Icon"] = ("Interface\\Icons\\" .. selectedTexture)
    end
end

local function mrp_IconCallbackGlance2Icon(selectedTexture)
    local profile = mrpSaved.SelectedProfile
    if(selectedTexture) then
        local mef = MyRolePlayGlanceEditFrame;
        mef.Glance2IconTexture:SetTexture("Interface\\Icons\\" .. selectedTexture)
        mrpSaved.Profiles[profile]["glances"][2]["Icon"] = ("Interface\\Icons\\" .. selectedTexture)
    end
end

local function mrp_IconCallbackGlance3Icon(selectedTexture)
    local profile = mrpSaved.SelectedProfile
    if(selectedTexture) then
        local mef = MyRolePlayGlanceEditFrame;
        mef.Glance3IconTexture:SetTexture("Interface\\Icons\\" .. selectedTexture)
        mrpSaved.Profiles[profile]["glances"][3]["Icon"] = ("Interface\\Icons\\" .. selectedTexture)
    end
end

local function mrp_IconCallbackGlance4Icon(selectedTexture)
    local profile = mrpSaved.SelectedProfile
    if(selectedTexture) then
        local mef = MyRolePlayGlanceEditFrame;
        mef.Glance4IconTexture:SetTexture("Interface\\Icons\\" .. selectedTexture)
        mrpSaved.Profiles[profile]["glances"][4]["Icon"] = ("Interface\\Icons\\" .. selectedTexture)
    end
end

local function mrp_IconCallbackGlance5Icon(selectedTexture)
    local profile = mrpSaved.SelectedProfile
    if(selectedTexture) then
        local mef = MyRolePlayGlanceEditFrame;
        mef.Glance5IconTexture:SetTexture("Interface\\Icons\\" .. selectedTexture)
        mrpSaved.Profiles[profile]["glances"][5]["Icon"] = ("Interface\\Icons\\" .. selectedTexture)
    end
end

local function mrp_DescripInsertColourChangedCallback(previousValues)
    local newR, newG, newB;
...
local function mrp_IconCallbackDescripInsert(selectedTexture)
...
function mrp:CreateEditFrames()
    ...
    if not MyRolePlayGlanceEditFrame then
        ...
        mef:SetPoint( "BOTTOM", MyRolePlayCharacterFrameInset or CharacterFrameInset, "BOTTOM", 0, 30 )
        ...
        mef.Glance1IconTexture = mef.Glance1Icon:CreateTexture("Glance1IconTexture", "ARTWORK")
        mef.Glance1IconTexture:SetTexture("Interface\\Icons\\INV_Misc_QuestionMark")
        mef.Glance1IconTexture:SetAllPoints(mef.Glance1Icon)

        mef.Glance1IconHighlightTexture = mef.Glance1Icon:CreateTexture("Glance1IconHighlightTexture", "HIGHLIGHT")
        mef.Glance1IconHighlightTexture:SetTexture("Interface\\AddOns\\MyRolePlay\\Artwork\\GlanceHighlight.blp")
        mef.Glance1IconHighlightTexture:SetAllPoints(mef.Glance1Icon)
        mef.Glance1IconHighlightTexture:Hide()
        ...
        mef.Glance1Descrip.Backdrop:SetPoint( "TOPLEFT", mef.Glance1Title, "BOTTOMLEFT", 0, 3)
        mef.Glance1Descrip.Backdrop:SetPoint( "BOTTOMRIGHT", mef.Glance1Title, "BOTTOMRIGHT", -5, -40)
        ...
        mef.Glance1Descrip:SetPoint( "TOPLEFT", mef.Glance1Title, "BOTTOMLEFT", 0, -5)
        mef.Glance1Descrip:SetPoint( "BOTTOMRIGHT", mef.Glance1Title, "BOTTOMRIGHT", -10, -30)
        mef.Glance1Descrip:EnableMouse(true)

        mef.Glance1Descrip.scrollBarHideable = false

        mef.Glance1Descrip.editbox = CreateFrame( "EditBox", nil, mef.sf )
        ...
        ScrollFrame_OnScrollRangeChanged(mef.Glance1Descrip)
        ...
        -- Clear glance button
        mef.Glance1Clear = CreateFrame( "Button", nil, mef, "UIPanelButtonTemplate" )
        ...
        mef.Glance2IconTexture = mef.Glance2Icon:CreateTexture("Glance2IconTexture", "ARTWORK")
        mef.Glance2IconTexture:SetTexture("Interface\\Icons\\INV_Misc_QuestionMark")
        mef.Glance2IconTexture:SetAllPoints(mef.Glance2Icon)
        ...
        mef.Glance2IconHighlightTexture = mef.Glance2Icon:CreateTexture("Glance2IconHighlightTexture", "HIGHLIGHT")
        mef.Glance2IconHighlightTexture:SetTexture("Interface\\AddOns\\MyRolePlay\\Artwork\\GlanceHighlight.blp")
        mef.Glance2IconHighlightTexture:SetAllPoints(mef.Glance2Icon)
        mef.Glance2IconHighlightTexture:Hide()
        ...
        mef.Glance2Descrip.Backdrop:SetPoint( "TOPLEFT", mef.Glance2Title, "BOTTOMLEFT", 0, 3)
        mef.Glance2Descrip.Backdrop:SetPoint( "BOTTOMRIGHT", mef.Glance2Title, "BOTTOMRIGHT", -5, -40)
        ...
        mef.Glance2Descrip:SetPoint( "TOPLEFT", mef.Glance2Title, "BOTTOMLEFT", 0, -5)
        mef.Glance2Descrip:SetPoint( "BOTTOMRIGHT", mef.Glance2Title, "BOTTOMRIGHT", -10, -30)
        mef.Glance2Descrip:EnableMouse(true)

        mef.Glance2Descrip.scrollBarHideable = false

        mef.Glance2Descrip.editbox = CreateFrame( "EditBox", nil, mef.sf )
        ...
        ScrollFrame_OnScrollRangeChanged(mef.Glance2Descrip)
        ...
        -- Clear glance button
        mef.Glance2Clear = CreateFrame( "Button", nil, mef, "UIPanelButtonTemplate" )
        ...
        mef.Glance3IconTexture = mef.Glance3Icon:CreateTexture("Glance3IconTexture", "ARTWORK")
        mef.Glance3IconTexture:SetTexture("Interface\\Icons\\INV_Misc_QuestionMark")
        mef.Glance3IconTexture:SetAllPoints(mef.Glance3Icon)
        ...
        mef.Glance3IconHighlightTexture = mef.Glance3Icon:CreateTexture("Glance3IconHighlightTexture", "HIGHLIGHT")
        mef.Glance3IconHighlightTexture:SetTexture("Interface\\AddOns\\MyRolePlay\\Artwork\\GlanceHighlight.blp")
        mef.Glance3IconHighlightTexture:SetAllPoints(mef.Glance3Icon)
        mef.Glance3IconHighlightTexture:Hide()
        ...
        mef.Glance3Descrip.Backdrop:SetPoint( "TOPLEFT", mef.Glance3Title, "BOTTOMLEFT", 0, 3)
        mef.Glance3Descrip.Backdrop:SetPoint( "BOTTOMRIGHT", mef.Glance3Title, "BOTTOMRIGHT", -5, -40)
        ...
        mef.Glance3Descrip:SetPoint( "TOPLEFT", mef.Glance3Title, "BOTTOMLEFT", 0, -5)
        mef.Glance3Descrip:SetPoint( "BOTTOMRIGHT", mef.Glance3Title, "BOTTOMRIGHT", -10, -30)
        mef.Glance3Descrip:EnableMouse(true)

        mef.Glance3Descrip.scrollBarHideable = false

        mef.Glance3Descrip.editbox = CreateFrame( "EditBox", nil, mef.sf )
        ...
        ScrollFrame_OnScrollRangeChanged(mef.Glance3Descrip)
        ...
        -- Clear glance button
        mef.Glance3Clear = CreateFrame( "Button", nil, mef, "UIPanelButtonTemplate" )
        ...
        mef.Glance4IconTexture = mef.Glance4Icon:CreateTexture("Glance4IconTexture", "ARTWORK")
        mef.Glance4IconTexture:SetTexture("Interface\\Icons\\INV_Misc_QuestionMark")
        mef.Glance4IconTexture:SetAllPoints(mef.Glance4Icon)
        ...
        mef.Glance4IconHighlightTexture = mef.Glance4Icon:CreateTexture("Glance4IconHighlightTexture", "HIGHLIGHT")
        mef.Glance4IconHighlightTexture:SetTexture("Interface\\AddOns\\MyRolePlay\\Artwork\\GlanceHighlight.blp")
        mef.Glance4IconHighlightTexture:SetAllPoints(mef.Glance4Icon)
        mef.Glance4IconHighlightTexture:Hide()
        ...
        mef.Glance4Descrip.Backdrop:SetPoint( "TOPLEFT", mef.Glance4Title, "BOTTOMLEFT", 0, 3)
        mef.Glance4Descrip.Backdrop:SetPoint( "BOTTOMRIGHT", mef.Glance4Title, "BOTTOMRIGHT", -5, -40)
        ...
        mef.Glance4Descrip:SetPoint( "TOPLEFT", mef.Glance4Title, "BOTTOMLEFT", 0, -5)
        mef.Glance4Descrip:SetPoint( "BOTTOMRIGHT", mef.Glance4Title, "BOTTOMRIGHT", -10, -30)
        mef.Glance4Descrip:EnableMouse(true)

        mef.Glance4Descrip.scrollBarHideable = false

        mef.Glance4Descrip.editbox = CreateFrame( "EditBox", nil, mef.sf )
        ...
        ScrollFrame_OnScrollRangeChanged(mef.Glance4Descrip)
        ...
        -- Clear glance button
        mef.Glance4Clear = CreateFrame( "Button", nil, mef, "UIPanelButtonTemplate" )
        ...
        mef.Glance5IconTexture = mef.Glance5Icon:CreateTexture("Glance5IconTexture", "ARTWORK")
        mef.Glance5IconTexture:SetTexture("Interface\\Icons\\INV_Misc_QuestionMark")
        mef.Glance5IconTexture:SetAllPoints(mef.Glance5Icon)
        ...
        mef.Glance5IconHighlightTexture = mef.Glance5Icon:CreateTexture("Glance5IconHighlightTexture", "HIGHLIGHT")
        mef.Glance5IconHighlightTexture:SetTexture("Interface\\AddOns\\MyRolePlay\\Artwork\\GlanceHighlight.blp")
        mef.Glance5IconHighlightTexture:SetAllPoints(mef.Glance5Icon)
        mef.Glance5IconHighlightTexture:Hide()
        ...
        mef.Glance5Descrip.Backdrop:SetPoint( "TOPLEFT", mef.Glance5Title, "BOTTOMLEFT", 0, 3)
        mef.Glance5Descrip.Backdrop:SetPoint( "BOTTOMRIGHT", mef.Glance5Title, "BOTTOMRIGHT", -5, -40)
        ...
        mef.Glance5Descrip:SetPoint( "TOPLEFT", mef.Glance5Title, "BOTTOMLEFT", 0, -5)
        mef.Glance5Descrip:SetPoint( "BOTTOMRIGHT", mef.Glance5Title, "BOTTOMRIGHT", -10, -30)
        mef.Glance5Descrip:EnableMouse(true)

        mef.Glance5Descrip.scrollBarHideable = false

        mef.Glance5Descrip.editbox = CreateFrame( "EditBox", nil, mef.sf )
        ...
        ScrollFrame_OnScrollRangeChanged(mef.Glance5Descrip)
        ...
        -- Clear glance button
        mef.Glance5Clear = CreateFrame( "Button", nil, mef, "UIPanelButtonTemplate" )
        ...
        mef.ok = CreateFrame( "Button", "MyRolePlayGlanceEditFrameOK", mef, "UIPanelButtonTemplate" )
        ...
        mef.cancel = CreateFrame( "Button", "MyRolePlayGlanceEditFrameCancel", mef, "UIPanelButtonTemplate" )
    ...
    if not MyRolePlayMultiEditFrame then
        ...
        mef:SetScript("OnShow", function(self)
            if mrp:IsMainlineClient() then
            CharacterFrame:SetWidth( 875 ) -- was 700
            elseif mrp:IsClassicClient() then
        ...
        mef.sf.editbox:SetScript( "OnTextChanged", function(self)
            ...
            if(mef.sf.editbox:GetNumLetters() > maxRecommendedCharacters[mrp.EditorShown]) then
                mef.ExcessiveTextWarning:Show();
            else
                mef.ExcessiveTextWarning:Hide();
            end
        end	)
        ...
        mef.ExcessiveTextWarning = CreateFrame("Frame", nil, mef)
        ...
        local excessiveTextTexture = mef.ExcessiveTextWarning:CreateTexture(nil, "ARTWORK")
        ...
        mef.ExcessiveTextWarning:SetScript("OnEnter", function (self)
            ...
            GameTooltip:AddLine( "This field of your profile is getting quite lengthy, over " .. maxRecommendedCharacters[mrp.EditorShown] .. " characters. You may exceed this, but it could deter some players and impact load times.", 1.0, 0.8, 0.06, true)
            GameTooltip:Show()
        end )
        ...
        -- Descrip link button
        mef.ilnk = CreateFrame( "Button", "MyRolePlayMultiEditFrame_LinkInsertButton", mef, "UIPanelButtonTemplate" )
        ...
        mef.icdb = CreateFrame( "Button", "MyRolePlayMultiEditFrame_DescripInsertColourButton", mef, "UIPanelButtonTemplate" )
        ...
        mef.icdb:SetScript("OnClick", function (self)
            ...
            mrp:ShowColorPicker(1, 1, 1, 1, mrp_DescripInsertColourChangedCallback)
        ...
        mef.ipb = CreateFrame( "Button", "MyRolePlayMultiEditFrame_DescripInsertParagraphButton", mef, "UIPanelButtonTemplate" )
        ...
        mef.ih1b = CreateFrame( "Button", "MyRolePlayMultiEditFrame_DescripInsertHeader1Button", mef, "UIPanelButtonTemplate" )
        ...
        -- Insert icon button
        mef.icb = CreateFrame( "Button", "MyRolePlayMultiEditFrame_InsertIconButton", mef, "UIPanelButtonTemplate" )
        ...
        -- Insert image button
        mef.imgb = CreateFrame( "Button", "MyRolePlayMultiEditFrame_InsertImageButton", mef, "UIPanelButtonTemplate" )
        ...
        mef.ppb = CreateFrame( "Button", "MyRolePlayMultiEditFrame_PreviewProfileButton", mef, "UIPanelButtonTemplate" )

        if mrp:IsMainlineClient() then
            mef.ppb:SetPoint( "LEFT", mef.imgb, "RIGHT", 5, 12 )
        elseif mrp:IsClassicClient() then
        ...
        mef.ok = CreateFrame( "Button", "MyRolePlayMultiEditFrameOK", mef, "UIPanelButtonTemplate" )
        ...
        mef.cancel = CreateFrame( "Button", "MyRolePlayMultiEditFrameCancel", mef, "UIPanelButtonTemplate" )
        mef.cancel:SetPoint( "RIGHT", mef.ok, "LEFT", -16, 0 )
        mef.cancel:SetText( L["cancel_button"] )
        mef.cancel:SetWidth( 90 )
        mef.cancel:SetScript( "OnEnter", function(self)
        ...
        mef.inherit = CreateFrame( "Button", "MyRolePlayMultiEditFrameInherit", mef, "UIPanelButtonTemplate" )
    ...
    if not MyRolePlayDescriptionPreviewFrame then
        ...
        if mrp:IsMainlineClient() then
            mdp:SetPoint( "BOTTOM", CharacterFrameInset, "BOTTOM", 0, 30 )
            mdp:SetPoint( "RIGHT", CharacterFrame, "RIGHT", -8, 0 )
        elseif mrp:IsClassicClient() then
        ...
        mdp.ppb = CreateFrame( "Button", "MyRolePlayDescriptionPreviewFrame_PreviewProfileButton", mdp, "UIPanelButtonTemplate" )

        if mrp:IsMainlineClient() then
            mdp.ppb:SetPoint( "TOPRIGHT", 8, 38 )
        elseif mrp:IsClassicClient() then
    ...
    if not MyRolePlayEditFrame then
        ...
        -- Name colour button
        mef.cpb = CreateFrame( "Button", "MyRolePlayCharacterFrame_ColourButton", mef, "UIPanelButtonTemplate" )

        if mrp:IsMainlineClient() then
            mef.cpb:SetPoint( "BOTTOMLEFT", mef.editbox, "BOTTOMLEFT", 20, -50 )
        elseif mrp:IsClassicClient() then
        ...
        local savedR, savedG, savedB
            ...
            mrp:ShowColorPicker(savedR, savedG, savedB, 1, mrp_NameColourChangedCallback)
        end )

        -- Eyes colour button
        mef.cepb = CreateFrame( "Button", "MyRolePlayCharacterFrame_EyeColourButton", mef, "UIPanelButtonTemplate" )

        if mrp:IsMainlineClient() then
            mef.cepb:SetPoint( "BOTTOMLEFT", mef.editbox, "BOTTOMLEFT", 20, -50 )
        elseif mrp:IsClassicClient() then
        ...
        mef.cepb:SetScript("OnClick", function (self)
            ...
            mrp:ShowColorPicker(savedR, savedG, savedB, 1, mrp_EyeColourChangedCallback)
        end )

        -- Restore name colour to default button
        mef.dfb = CreateFrame( "Button", "MyRolePlayCharacterFrame_RestoreDefaultColourButtonName", mef, "UIPanelButtonTemplate" )
        ...
        mef.dfbe = CreateFrame( "Button", "MyRolePlayCharacterFrame_RestoreDefaultColourButtonEyes", mef, "UIPanelButtonTemplate" )
        ...
        mef.ok = CreateFrame( "Button", "MyRolePlayEditFrameOK", mef, "UIPanelButtonTemplate" )
        ...
        mef.cancel = CreateFrame( "Button", "MyRolePlayEditFrameCancel", mef, "UIPanelButtonTemplate" )
        mef.cancel:SetPoint( "RIGHT", mef.ok, "LEFT", -16, 0 )
        mef.cancel:SetText( L["cancel_button"] )
        mef.cancel:SetWidth( 90 )
        mef.cancel:SetScript( "OnEnter", function(self)
        ...
        mef.inherit = CreateFrame( "Button", "MyRolePlayEditFrameInherit", mef, "UIPanelButtonTemplate" )
        mef.inherit:SetPoint( "LEFT", mef )
        mef.inherit:SetPoint( "TOP", mef.ok )
        mef.inherit:SetText( L["editor_inherit_button"] )
        mef.inherit:SetWidth( 90 )
    ...
    if not MyRolePlayTraitsEditFrame then
        ...
        if mrp:IsMainlineClient() then
            mef.sf:SetPoint( "TOPLEFT", 20, 25 )
            mef.sf:SetPoint( "BOTTOMRIGHT", -21, 28 )
        elseif mrp:IsClassicClient() then
        ...
        mef.new = CreateFrame( "Button", "MyRolePlayTraitsEditFrameNew", mef, "UIPanelButtonTemplate" )

        if mrp:IsMainlineClient() then
            mef.new:SetPoint( "BOTTOMRIGHT", CharacterFrame, "BOTTOMRIGHT", -112, 33 )
        elseif mrp:IsClassicClient() then
        ...
        mef.ok = CreateFrame( "Button", "MyRolePlayTraitsEditFrameOK", mef, "UIPanelButtonTemplate" )
        ...
        mef.cancel = CreateFrame( "Button", "MyRolePlayTraitsEditFrameCancel", mef, "UIPanelButtonTemplate" )
        mef.cancel:SetPoint( "RIGHT", mef.ok, "LEFT", -16, 0 )
        mef.cancel:SetText( L["cancel_button"] )
        mef.cancel:SetWidth( 90 )
        mef.cancel:SetScript( "OnEnter", function(self)
    ...
    if not MyRolePlayComboEditFrame then
        ...
        mef.ok = CreateFrame( "Button", "MyRolePlayComboEditFrameOK", mef, "UIPanelButtonTemplate" )
        ...
        mef.cancel = CreateFrame( "Button", "MyRolePlayComboEditFrameCancel", mef, "UIPanelButtonTemplate" )
        mef.cancel:SetPoint( "RIGHT", mef.ok, "LEFT", -16, 0 )
        mef.cancel:SetText( L["cancel_button"] )
        mef.cancel:SetWidth( 90 )
        mef.cancel:SetScript( "OnEnter", function(self)
        ...
        mef.inherit = CreateFrame( "Button", "MyRolePlayComboEditFrameInherit", mef, "UIPanelButtonTemplate" )
        mef.inherit:SetPoint( "LEFT", mef )
        mef.inherit:SetPoint( "TOP", mef.ok )
        mef.inherit:SetText( L["editor_inherit_button"])
        mef.inherit:SetWidth( 90 )
