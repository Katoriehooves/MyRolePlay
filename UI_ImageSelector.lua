...
local function search_update()
    ...
    if(MRPImageSelectSearchBox:HasFocus() == false) then
        return;
    end

    imageFilenames = { };

    local searchBoxContents = MRPImageSelectSearchBox:GetText():upper()
...
local create = function()
    ...
    -- Search box
    f.search_box = CreateFrame( "EditBox", "MRPImageSelectSearchBox", f )
