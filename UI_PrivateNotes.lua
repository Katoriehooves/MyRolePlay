...
function mrp:CreateNotesFrame()
    if not MyRolePlayNotesFrame then
        ...
        nf.ok = CreateFrame( "Button", "MyRolePlayNotesFrameOK", nf, "UIPanelButtonTemplate" )
        ...
        nf.cancel = CreateFrame( "Button", "MyRolePlayNotesFrameCancel", nf, "UIPanelButtonTemplate" )
