...
L["editor_reportbug_button"] = "Report a bug."
L["editor_reportbug_button_tt"] = "Presents a link to the MyRolePlay issues page, where you can report bugs."
L["editor_changelog_button"] = "View change log / patch notes."
L["editor_changelog_button_tt"] = "View the most recent updates to MyRolePlay, explaining new functionality or changes."
...
L["editor_insertcolour_tt_2"] = "{col:ff0000}Draenei have hooves.{/col}"
...
L["editor_insertlink_tt_2"] = "Example:\n{link*http://www.worldofwarcraft.com/*WoW Website}"
...
--
L["opt_increasecolourcontrast"] = "Increase colour contrast"
L["opt_increasecolourcontrast_tt"]= [[Brighten dark names and class colours in the tooltip / chat box.

This will produce an inaccurate colour but make it easier to read.]]
--
L["opt_showglancepreview"] = "Show glance target box"
...
--
L["opt_showfullversiontext"] = "Show full version text"
L["opt_showfullversiontext_tt"] = [[Show the complete addon version along with the name.]]
--
...
--
L["opt_rpchatnameguild"] = "|cff40fb40/guild + /officer|r"
L["opt_rpchatnameguild_tt"]= [[Shows RP names in /guild and /officer, where known and available.]]
--
L["opt_highlightemotes"] = "Highlight |cffff8040*emotes*|r in chat |cffff5533(Beta feature)|r"
L["opt_highlightemotes_tt"]= [[Highlight emotes contained within |cffff8040*emote*|r in chat channels.

|cffff8040BETA FEATURE: This functionality automatically disables when a potentially conflicting chat addon is detected, such as ElvUI, Prat, or Listener.|r]]
--
L["opt_highlightooc"] = "Highlight |cffaaaaaa((OOC))|r in chat |cffff5533(Beta feature)|r"
L["opt_highlightooc_tt"]= [[Highlight OOC chat contained in |cffaaaaaa((OOC))|r in chat channels
...
L["CLIENT_UNSUPPORTED_WARNING_TEXT"] = "You are attempting to run MyRolePlay |cffffcc00*%1$s*|r on a |cffff0000*%2$s*|r World of Warcraft client.|n|nPlease download and install the appropriate version from CurseForge or WoWInterface.";
L["CLIENT_TYPE_CLASSIC"] = "Classic";
L["CLIENT_TYPE_MAINLINE"] = "Retail";
